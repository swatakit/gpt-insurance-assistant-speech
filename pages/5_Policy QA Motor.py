...
from api.openai_qa_motor import *
...
if "messages_motor" not in st.session_state:
    st.session_state.messages_motor = []
...
for message in st.session_state.messages_motor:
...
if new_input:
    ...
    st.session_state.messages_motor.append({"role": "user", "content": new_input})
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            st.session_state.messages_motor.append({"role": "assistant", "content": full_response})
